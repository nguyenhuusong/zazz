...
@Component({
  selector: 'app-import-cap-bac-luong',
  templateUrl: './import-cap-bac-luong.component.html',
  styleUrls: ['./import-cap-bac-luong.component.scss']
})
export class ImportCapBacLuongComponent implements OnInit {
  items: any = [];
  isFullScreen = false;
  heightGrid = 0
  isShowUpload = true;
