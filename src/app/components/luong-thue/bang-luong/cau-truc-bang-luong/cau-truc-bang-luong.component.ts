...
@Component({
  selector: 'app-cau-truc-bang-luong',
  templateUrl: './cau-truc-bang-luong.component.html',
  styleUrls: ['./cau-truc-bang-luong.component.scss']
})
export class CauTrucBangLuongComponent implements OnInit {
  tabsItem = []
  excelStyles = [
    {
      id: 'stringType',
