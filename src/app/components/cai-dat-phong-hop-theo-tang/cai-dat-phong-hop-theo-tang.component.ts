...
@Component({
  ...
  templateUrl: './cai-dat-phong-hop-theo-tang.component.html',
  styleUrls: ['./cai-dat-phong-hop-theo-tang.component.scss']
})
export class CaiDatPhongHopTheoTangComponent implements OnInit {
