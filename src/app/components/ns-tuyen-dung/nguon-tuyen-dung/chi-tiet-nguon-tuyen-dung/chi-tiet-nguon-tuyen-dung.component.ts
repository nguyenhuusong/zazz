...
@Component({
  ...
  templateUrl: './chi-tiet-nguon-tuyen-dung.component.html',
  styleUrls: ['./chi-tiet-nguon-tuyen-dung.component.scss']
})
export class ChiTietNguonTuyenDungComponent implements OnInit, OnDestroy {
  items: MenuItem[] = [];
  paramsObject = null;
  detailInfo = null
  listViews = [];
  ...
  getDetail() {
    this.listViews = []
    const queryParams = queryString.stringify({sourceId: this.idForm});
