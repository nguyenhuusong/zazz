...
@Component({
  ...
  templateUrl: './mail-tuyen-dung.component.html',
  styleUrls: ['./mail-tuyen-dung.component.scss']
})
export class MailTuyenDungComponent implements OnInit, AfterViewChecked {
    ...
    return {
      buttons: [
        ...
        },
        {
          ...
          icon: 'pi pi-trash',
          class: 'btn-primary mr5',
          hide: CheckHideAction(MENUACTIONROLEAPI.GetRecruitMailPage.url, ACTIONS.DELETE)
        },
      ]
    };
  }
