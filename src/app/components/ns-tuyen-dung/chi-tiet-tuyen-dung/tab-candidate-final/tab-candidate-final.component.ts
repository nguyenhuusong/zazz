...
@Component({
  selector: 'app-tab-candidate-final',
  templateUrl: './tab-candidate-final.component.html',
  styleUrls: ['./tab-candidate-final.component.scss']
})
export class TabCandidateFinalComponent implements OnInit, OnDestroy {
  items: MenuItem[] = [];
  detailInfo = null
  listViews = [];
  optionsButon = [
  ...
  getCandidateFinal() {
    ...
    this.apiService.getCandidateFinal(queryParams)
