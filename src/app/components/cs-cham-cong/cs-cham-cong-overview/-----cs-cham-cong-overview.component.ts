...
@Component({
  ...
  templateUrl: './cs-cham-cong-overview.component1.html',
  styleUrls: ['./cs-cham-cong-overview.component1.scss']
})
export class CsChamCongOverviewComponent1 implements OnInit {
