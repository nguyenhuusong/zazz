...
export class KeHoachTuyenDungComponent implements OnInit, AfterViewChecked {
  ...
  editRow({rowData}) {
    this.isDetail = true;
    this.recruitPlanId = rowData.recruitPlanId;
  }
  ...
  ngOnInit() {
    this.items = [
      ...
      { label: 'Tuyển dụng' },
      { label: 'Danh sách kế hoạch tuyển dụng' },
    ];
