...
@Component({
  selector: 'app-tab-salary-insurance',
  templateUrl: './tab-salary-insurance.component.html',
  styleUrls: ['./tab-salary-insurance.component.scss']
})
export class TabSalaryInsuranceComponent implements OnInit {
  @Input() recordId = null;
  ...
  status = [];
  getSalaryInsurancePage() {
    this.spinner.show();
    this.columnDefs = [];
    const queryParams = queryString.stringify({...this.query });
    this.apiService.getSalaryInsurancePage(queryParams)
