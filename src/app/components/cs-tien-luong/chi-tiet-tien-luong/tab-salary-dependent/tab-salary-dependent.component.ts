...
@Component({
  selector: 'app-tab-salary-dependent',
  templateUrl: './tab-salary-dependent.component.html',
  styleUrls: ['./tab-salary-dependent.component.scss']
})
export class TabSalaryDependentComponent implements OnInit {
  @Input() recordId = null;
  ...
  status = [];
  getSalarydependentPage() {
    this.spinner.show();
    this.columnDefs = [];
    const queryParams = queryString.stringify({...this.query });
    this.apiService.getSalarydependentPage(queryParams)
