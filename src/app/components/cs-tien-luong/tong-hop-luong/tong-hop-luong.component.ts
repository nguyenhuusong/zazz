...
@Component({
  selector: 'app-tong-hop-luong',
  templateUrl: './tong-hop-luong.component.html',
  styleUrls: ['./tong-hop-luong.component.scss']
})
export class TongHopLuongComponent implements OnInit {
  @Input() recordId = null;
  ...
  getSalaryTotalPage() {
    ...
    this.apiService.getSalaryTotalPage(queryParams)
