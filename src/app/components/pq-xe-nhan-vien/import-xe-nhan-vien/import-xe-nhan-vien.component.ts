...
@Component({
  selector: 'app-import-xe-nhan-vien',
  templateUrl: './import-xe-nhan-vien.component.html',
  styleUrls: ['./import-xe-nhan-vien.component.scss']
})
export class ImportXeNhanVienComponent implements OnInit {
  items: any = [];
  isFullScreen = false;
  heightGrid = 0
  isShowUpload = true;
