...
@Component({
  selector: 'app-import-cong-ty',
  templateUrl: './import-cong-ty.component.html',
  styleUrls: ['./import-cong-ty.component.scss']
})
export class ImportCongTyComponent implements OnInit {
  items: any = [];
  isFullScreen = false;
  heightGrid = 0
  isShowUpload = true;
