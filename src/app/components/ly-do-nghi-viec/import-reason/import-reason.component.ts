...
@Component({
  selector: 'app-import-reason',
  templateUrl: './import-reason.component.html',
  styleUrls: ['./import-reason.component.scss']
})
export class ImportReasonComponent implements OnInit {
  items: any = [];
  isFullScreen = false;
  heightGrid = 0
  isShowUpload = true;
