...
@Component({
  selector: 'app-import-wifi',
  templateUrl: './import-wifi.component.html',
  styleUrls: ['./import-wifi.component.scss']
})
export class ImportWifiComponent implements OnInit {
  items: any = [];
  isFullScreen = false;
  heightGrid = 0
  isShowUpload = true;
  ...
  onSelectFile(event) {
    if (event.currentFiles.length > 0) {
      ...
      this.apiService.setTimekeepingWifiImport(fomrData)
